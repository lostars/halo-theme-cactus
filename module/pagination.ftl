<div class="pagination">
    ...
    <#if posts.number == 1><a href="${context!}"><i class="fas fa-angle-left"></i>
        <#else><a href="${context!}/page/${posts.number}"><i class="fas fa-angle-left"></i>
            </#if>
            </#if>
            <span class="page-number">Page <#if posts.number <= 1>1<#else>${posts.number}</#if> of ${posts.totalPages!}</span>
            <#if posts.hasNext()>
